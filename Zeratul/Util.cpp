...
int Util::GetUnitTypeMineralPrice(const sc2::UnitTypeID type, const Zeratul & bot)
{
...
int Util::GetUnitTypeGasPrice(const sc2::UnitTypeID type, const Zeratul & bot)
{
    return bot.Observation()->GetUnitTypeData()[type].vespene_cost;
}

int Util::GetUnitTypeWidth(const sc2::UnitTypeID type, const Zeratul & bot)
{
    return (int)(2 * bot.Observation()->GetAbilityData()[bot.Data(type).buildAbility].footprint_radius);
}

int Util::GetUnitTypeHeight(const sc2::UnitTypeID type, const Zeratul & bot)
{
    return (int)(2 * bot.Observation()->GetAbilityData()[bot.Data(type).buildAbility].footprint_radius);
}
...
float Util::GetAttackRange(const sc2::UnitTypeID & type, Zeratul & bot)
{
...
bool Util::IsCombatUnitType(const sc2::UnitTypeID & type, Zeratul & bot)
{
...
bool Util::hasReactor(const sc2::Unit * unit, Zeratul &bot)
{
...
bool Util::IsCombatUnit(const sc2::Unit * unit, Zeratul & bot)
{
    BOT_ASSERT(unit, "Unit pointer was null");
...
sc2::UnitTypeID Util::GetUnitTypeIDFromName(const std::string & name, Zeratul & bot)
{
...
sc2::UpgradeID Util::GetUpgradeIDFromName(const std::string & name, Zeratul & bot)
{
...
sc2::BuffID Util::GetBuffIDFromName(const std::string & name, Zeratul & bot)
{
...
sc2::AbilityID Util::GetAbilityIDFromName(const std::string & name, Zeratul & bot)
{
...
bool Util::UnitCanBuildTypeNow(const sc2::Unit * unit, const sc2::UnitTypeID & type, Zeratul & m_bot)
{
    BOT_ASSERT(unit, "Unit pointer was null");
...
const sc2::Unit* Util::getClosestPylon(Zeratul & bot)
{
